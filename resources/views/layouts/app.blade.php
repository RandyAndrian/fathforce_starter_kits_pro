...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="{{ asset('landing/assets/css/style.css')}}" />
...
<body>
	<div class="hero" id="hero">
		<nav class="navbar navbar-expand-lg">
			<a class="navbar-brand" href="https://fathforce.com"><img
					src="{{ asset('landing/assets/images/Logo-Fathforce-White-New-Persegi-Transparant.png')}}" width="1024" height="300"
					alt="Fathforce" />
	...
	<script type="text/javascript" src="{{ asset('landing/assets/js/main.js')}}"></script>
