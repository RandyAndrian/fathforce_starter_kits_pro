        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
           ...
           <img src="{{ asset('landing/assets/images/Logo-Fathforce-White-New-Persegi-Transparant.png')}}" width="300" height="300" alt="Fathforce">
                ...
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                      ...
                      <label class="custom-control-label" for="{{ __('Remember Me') }}">Remember Me</label>
                    </div>
                  </div>
            ...
            <div class="simple-footer text-center mt-2 mb-2">
              Copyright &copy; Muhamad Randy Andrian 2021
            </div>
